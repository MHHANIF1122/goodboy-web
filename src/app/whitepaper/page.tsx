...
export default function Whitepaper() {
  return (
    ...
    <section className="wp-card">
      <h2>Liquidity Roadmap</h2>
      <div>
        <ul><strong>Phase 1 – Genesis</strong>
        ...
        <ul><strong>Phase 2 – Growth</strong>
        ...
        <ul><strong>Phase 3 – Maturity</strong>
